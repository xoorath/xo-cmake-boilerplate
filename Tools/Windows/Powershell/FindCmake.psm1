...
function Get-Cmake()
{
    ...
    $VSInstallPath = Get-VSSetupInstance | Select-Object -ExpandProperty InstallationPath
    ...
    if([string]::IsNullOrWhiteSpace($VSInstallPath) -or -not (Test-Path $VSInstallPath)) {
        ...
        throw "Cmake not installed. Please install cmake.`nhttps://cmake.org/install/"
    }
